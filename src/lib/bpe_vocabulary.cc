...
vector<string> BPEVocabulary::convertToTokens(const string & sentence) const {
  vector<string> words;
  boost::split(
      words, sentence, boost::is_space(), boost::algorithm::token_compress_on);
...
vector<string> BPEVocabulary::convertToTokenizedSentence(
    const vector<unsigned> & word_ids) const {
  string sentence = convertToSentence(word_ids);
  vector<string> words;
  boost::split(
      words, sentence, boost::is_space(), boost::algorithm::token_compress_on);
  return words;
